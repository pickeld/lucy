...
Usage:
    ...
    python scripts/test_e2e.py --image

    # Image with custom URL and caption
    python scripts/test_e2e.py --image --image-url "https://example.com/photo.jpg" --caption "Check out this sunset!"

    # Image in a group chat
    python scripts/test_e2e.py --image --group --caption "Meeting whiteboard photo"
"""
